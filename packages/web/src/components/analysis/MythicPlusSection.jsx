...
export default function MythicPlusSection({ raiderIO, mplusAnalysis, characterId, compact = false }) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-void-mid/30 rounded-xl border border-void-bright/10 p-4">
            ...
            <ResponsiveContainer width="100%" height={Math.max(dungeonChartData.length * 32, 120)}>
              <BarChart data={dungeonChartData} layout="vertical" margin={{ left: 0, right: 10, top: 0, bottom: 0 }}>
                <XAxis type="number" tick={{ fill: '#9ca3af', fontSize: 10 }} domain={[0, 'dataMax + 2']} />
            ...
            {pushTargets.length === 0 ? (
              ...
              <div className="space-y-2">
                {pushTargets.map((target, i) => (
                  <div key={i} className="p-3 rounded-lg bg-void-deep/50 border border-void-bright/5">
